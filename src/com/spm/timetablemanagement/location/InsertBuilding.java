...
public class InsertBuilding extends javax.swing.JPanel {
    ...
    public void addBuilding() throws ClassNotFoundException, IOException{
        String STag = type.getText();
        String query = "Select id FROM building WHERE name = ?";
        String colName = "id";
        if ( type.getText().isEmpty()){
            JOptionPane.showMessageDialog(this, "Please enter details");
        }else{
            try {
                if(isExist(STag, query, colName)){
                    JOptionPane.showMessageDialog(this, "This Building Name Already Exist");
                    type.grabFocus();
                }else{
                    Name = type.getText();
    ...
    public void updateBuilding() throws ClassNotFoundException, IOException{
        String STag = type.getText();
        String query = "Select id FROM building WHERE name = ?";
        String colName = "id";
        if(id.getText().isEmpty()){
    ...
    public boolean isExist(String col1, String query, String colName) throws SQLException, ClassNotFoundException, IOException {
