...
public class InsertRoom extends javax.swing.JPanel {
    ...
    public void addRoom() throws ClassNotFoundException, IOException{
        
        String STag = name.getText();
        ...
        if (name.getText().isEmpty() || cmb_type.getSelectedItem().toString().isEmpty()|| cmb_type.getSelectedItem().toString().isEmpty()){
            ...
            try {
                if(isExist(STag, query, colName)){
                    JOptionPane.showMessageDialog(this, "This Room Name Already Exist");
                    name.grabFocus();
                }else{
    ...
    public void updateRoom() throws ClassNotFoundException, IOException{
        String STag = name.getText();
        String query = "Select id FROM room WHERE name = ?";
        String colName = "id";
        if(id.getText().isEmpty()){
