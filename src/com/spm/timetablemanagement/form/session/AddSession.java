...
public class AddSession extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmb_tag.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select", "Lec", "Lab", "Tutorial" }));
...
//                   statement.setString(5, null);
    ...
    private void getDuration(){
        ...
        if((index_sub != 0)&& (index_tag != 0)){
            ...
            else if(cmb_tag.getSelectedItem().toString().contentEquals("Practicle")){
        ...
        if(index_tag != 0){
            ...
            if(cmb_tag.getSelectedItem().toString().contentEquals("Lec")){
            ...
            else if(cmb_tag.getSelectedItem().toString().contentEquals("Lab")){
        ...
        try {
            ...
            while(resultSet.next()){
               tag t = new tag();
                ...
                t.setRelatedTag(resultSet.getString("relatedTag"));
            ...
            for(i =1;i <= tagList.size();i++){
                ...
                tags[i] = tagList.get(i-1).getRelatedTag();
            }
